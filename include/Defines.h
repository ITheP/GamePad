...
// NONE is defined in LovyanGFX as NON = 0x00
...
#define DIGITAL_PRESSED 0x0
#define DIGITAL_NOT_PRESSED 0x1
#define DIGITAL_LONG_PRESS_MONITORING 0x2
//#define DIGITAL_LONG_PRESSED 0x3
